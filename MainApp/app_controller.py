...
def decrypt_choose_private_key_click(app):
    ...
    if private_key_file_path != '':
        if private_key_file_path.endswith(".pem"):
            app.set_frame(SelectPrivateKeyFrame, file_path=file_path, private_key_file_path=private_key_file_path, valid_file_extension=True)
            app_storage.set_public_key_file_path(private_key_file_path)
        else:
            app.set_frame(SelectPrivateKeyFrame, file_path=file_path, private_key_file_path=private_key_file_path, valid_file_extension=False)
